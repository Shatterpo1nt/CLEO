...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  CLÉO — Netlify via Personal Token"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "1. Va sur : https://app.netlify.com/user/applications"
echo "2. Section 'Personal access tokens' → 'New access token'"
echo "3. Nom : cleo, pas d'expiration → Generate"
echo "4. Copie le token (commence par 'nf...')"
echo ""
read -rp "Colle ton token ici : " NETLIFY_TOKEN
echo ""

if [ -z "$NETLIFY_TOKEN" ]; then
  echo "❌ Token vide. Réessaie."
...
if ! echo "$STATUS" | grep -qi "Email:"; then
  echo ""
  echo "❌ Token invalide. Vérifie et réessaie."
  read -rp "Entrée pour fermer..."
  exit 1
fi
...
set_var() {
  ...
  local VAL=$2
  local RESULT
  RESULT=$(NETLIFY_AUTH_TOKEN="$NETLIFY_TOKEN" netlify env:set "$KEY" "$VAL" --site merci-cleo 2>&1)
...
NETLIFY_AUTH_TOKEN="$NETLIFY_TOKEN" netlify env:list --site merci-cleo 2>&1 | head -30
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
